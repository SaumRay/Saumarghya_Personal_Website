...
import { FolderKanban, Mail, Images, BookOpen, MailOpen } from "lucide-react";
...
export function AdminOverview() {
  ...
  const [stats, setStats] = useState<Stats>({ projects: 0, messages: 0, unreadMessages: 0, galleries: 0, notes: 0 });
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      .then(([projects, contact, gallery, notes]) => {
        setStats({
